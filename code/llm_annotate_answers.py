...
data/answers_llm_annotated.csv, reproduced here for methodological
...
Annotates AR answers with FEIT/CAU/OOR/ADV/DEFL labels using Claude via the
...
from paths import ANSWERS_SOURCE as INPUT_CSV, ANSWERS_OUTPUT as OUTPUT_CSV, STATE_DIR
...
STATE_FILE       = STATE_DIR / "batch_state_answers.json"
STATE_FILE_RETRY = STATE_DIR / "batch_state_answers_retry.json"
